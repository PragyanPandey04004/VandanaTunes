...
VandanaTunes is a Flutter-based Android music player that keeps its core UX in Dart while using native Kotlin playback plumbing for media controls, audio focus, and notification handling.
...
1. **Clone the repository:**
    ...
    ```sh
    ❯ git clone https://github.com/PragyanPandey3006/VandanaTunes.git
    ```
...
- **💬 [Join the Discussions](https://github.com/PragyanPandey3006/VandanaTunes/discussions)**: Share feedback, ideas, and design suggestions.
- **🐛 [Report Issues](https://github.com/PragyanPandey3006/VandanaTunes/issues)**: Submit bugs or request features for VandanaTunes.
- **💡 [Submit Pull Requests](https://github.com/PragyanPandey3006/VandanaTunes/pulls)**: Open a PR with focused, reviewable changes.
...
<br>
<p align="left">
   <a href="https://github.com/PragyanPandey3006/VandanaTunes/graphs/contributors">
      <img src="https://contrib.rocks/image?repo=PragyanPandey3006/VandanaTunes">
   </a>
</p>
</details>

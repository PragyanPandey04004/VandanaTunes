...
class MainActivity : FlutterActivity() {
    ...
    private val playerCommandsChannel = "com.pragyan.vandanatunes/player_commands"
    private val playerEventsChannel = "com.pragyan.vandanatunes/player_events"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "vandanatunes/extract")
            .setMethodCallHandler { call, result ->

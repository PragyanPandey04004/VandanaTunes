    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildListTile('App', trailing: const Text('Vandana Tunes', style: TextStyle(color: accentPrimary, fontWeight: FontWeight.bold))),
          _buildListTile('Developer', trailing: const Text('Pragyan Pandey', style: TextStyle(color: textPrimary))),
          _buildListTile('Contact', trailing: const Text('pragyan@pragyanpandey.com', style: TextStyle(color: accentPrimary))),
          const SizedBox(height: 32),
        ],
      ),
    );
